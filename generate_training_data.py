...
Case                = 'LiftBoom'            #Patu else 'LiftBoom'
endTime             = 1                 #total simulation time of training/test data, change to 2 for Patu
nStepsTotal         = int(200*endTime)  #number of steps used for training/test data
LiftLoad            = 0
Material            = 'Steel'           #Steel, Aluminium, Titanium and Composites
model               = SLIDEModel(nStepsTotal=nStepsTotal, endTime=endTime, nnType='FFN', 
                                    system=Case, nModes= 30, 
...
nTest               = nTrain*2                  #16*2
dataFile            = f"solution/data/{Case}/data{Material}_{endTime}T_{nTraining}nTrainings_{nTest}nTests_{nStepsTotal}steps_Load{LiftLoad}"
